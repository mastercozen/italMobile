	...
	if (activeObject && activeObject.type === 'text') {
 	...
 	$(document).ready(function() {
		...
		document.getElementById('add-text').onclick = function() {
			...
			if (text ==""){
				bootbox.alert("You must put a text.");
	  ...
	  $("#font-family").change(function() {
	   ...
	   line1 = new fabric.Line([0,0,5000,0], {"stroke":"#000000", "strokeWidth":1,hasBorders:false,hasControls:false,hasRotatingPoint:false,selectable:false});
