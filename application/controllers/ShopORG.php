...
class Shop extends CI_Controller {
    public function index() {
        ...
        $stat["contest_status"] = $this->Contest_model->get_contest_status();
        ...
        if($this->session->userdata('customer_logged_in')){
            ...
            $this->load->view('customer/shop-view',$data);
            //--------------------------------------------------
    ...
    public function place_order(){
		...
		$config['cancel_return'] = base_url().'shop';
		$config['notify_url'] = base_url().'shop/after_payment';
    ...
    public function after_payment(){
    	...
    	if(!$_POST){
	        ...
	        if($invoice_check==false){
	            ...
	            redirect('shop/destroy_cart','refresh');
	        }
	        else{
	            redirect('shop','refresh');
	        }
