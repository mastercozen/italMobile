        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    <li><a href="<?php echo base_url() ?>staff_page/inventory_in_online">Online In</a></li> 
                    <li><a href="<?php echo base_url() ?>staff_page/inventory_out_online">Online Out</a></li>
                    <li><a href="<?php echo base_url() ?>staff_page/inventory_in_walkin">Walkin In</a></li>
                    <li><a href="<?php echo base_url() ?>staff_page/inventory_out_walkin">Walkin Out</a></li>
                </ul>
            </div>
        </nav>
        <div class="row">
               ...
               <table id="example" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td class="info"><?php echo $x->one ?></td>
                            <?php endif ?>
                        </tr>
                        <?php endforeach ?>
                    </tbody>
