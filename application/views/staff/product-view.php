...
<div class="modal fade madal" id="add-product-modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url() . 'staff_page/add_product' ?>" enctype="multipart/form-data">
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="name" name="sizing">
                        <option value="One">One size (For One-sized items e.g. Bracelets,Necklaces,etc.)</option>
                        <option value="Multi">Multi size (For Multi-sized items e.g. Shirts,Jackets,etc.)</option>
                    </select>
                </div>
                <div class="form-group">
                    <label>Color</label>
                    <input type="text" class="form-control" id="name" name="color" placeholder="" value="<?php echo set_value('color');?>">
                </div>
                <div class="form-group">
...
<div class="modal fade modal" id="edit-product-modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url() . 'staff_page/update_product' ?>" enctype="multipart/form-data">     
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Color</label>
                    <input type="text" class="form-control" id="edit-color" name="color" placeholder="" value="">
                </div>
                <div class="form-group">
                    <label>Description</label>
...
<div class="modal fade modal" id="view-image-modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url() . 'staff_page/update_product_image' ?>" enctype="multipart/form-data">
...
<script>
    function delete_product(id) {
        bootbox.confirm("Are you sure you want to delete This item?", function(result) {
            if (result)
                window.location = "<?php echo base_url() . 'staff_page/delete_product/' ?>" + id;
        });
    }
</script>
<script>
    function edit_product(id){
        $.LoadingOverlay("show");
        $.ajax({
            url : "<?php echo base_url('staff_page/ajax_view_product_by_id')?>/"+id,
            type: "POST",
...
<div class="modal fade modal" id="add-product-type-modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url() . 'staff_page/add_product_type' ?>">
            <div class="modal-body">
                <div class="form-group">
...
function delete_type(type){
        $.LoadingOverlay("show");
        $.ajax({
            url : "<?php echo base_url('staff_page/delete_product_type')?>/"+type,
            type: "POST",
            success: function(data){
                var json = JSON.parse(data);
