                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="divider"></li>
                                        <li><a href="<?php echo base_url()?>staff_page/update_to_processing?id=<?php echo $order->invoice_id?>">Process now</a></li>
                                        <?php } ?>

                                        <?php if($order->order_status=="Processing"){?>
                                        <li class="divider"></li>
                                        <li><a href="#" onclick="ship_now('<?php echo $order->invoice_id ?>');">Ship now</a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            </td>
...
<script>
    function ship_now(id) {
        bootbox.confirm("<font size='4'><b>Are you sure you want to Ship this order now?</b></font><br> <font color='#f00'>Note: Email Notification will be sent to the customer that his/her Order is now shipped.</font>", function(result) {
            if (result)
                window.location = "<?php echo base_url()?>staff_page/update_to_shipped?id=" + id;
        });
    }
</script>