...
<script>
    function deactivate_user(id) {
        bootbox.confirm("Are you sure you want to deactivate this account?", function(result) {
            if (result)
                window.location = "<?php echo base_url() . 'administrator_page/deactivate_customer?id=' ?>" + id;
        });
    }
    function activate_user(id) {
        bootbox.confirm("Are you sure you want to activate this account?", function(result) {
            if (result)
                window.location = "<?php echo base_url() . 'administrator_page/activate_customer?id=' ?>" + id;
        });
    }
</script>
