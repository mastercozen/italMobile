<div class="content-wrapper">
    <div class="container-fluid">
        <a href="<?php echo base_url()?>administrator_page/reports" class="btn btn-primary btn-md">Go Back</a>
            ...
            <div class="col-md-12">
                <table id="example" class="table table-striped table-hover" cellspacing="0" width="100%">
                    ...
                    <?php foreach ($results as $result) { ?>
                        ...
                        <tr class="info">
                            <td><?php echo date("F jS, Y h:i:sa",strtotime($result->date_ordered)) ?></td>
