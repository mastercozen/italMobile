...
<div class="modal fade madal" id="view-specific-date-report" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url()?>administrator_page/reports_specific_date" method="post">
...
<div class="modal fade madal" id="view-month-report" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url()?>administrator_page/reports_specific_m_y" method="post">
            <div class="modal-body">
...
<div class="modal fade madal" id="view-year-report" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url()?>administrator_page/reports_specific_year" method="post">
            <div class="modal-body">
