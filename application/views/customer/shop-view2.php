                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-warning">
                                ...
                                <div class="panel-body">
                                    <?php echo form_open('shop/update_Cart'); ?><form action="<?php echo base_url() ?>shop/update_Cart" method="post">
                                        <table class="table table-striped">
                                            ...
                                            <?php foreach ($this->cart->contents() as $items): ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="<?= base_url() ?>shop/remove_to_cart/<?php echo $items['rowid'] ?>" >Remove</a>
                                                    </td>
                                        ...
                                        <!--<button type="submit" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-repeat"></span> Update Cart</button>-->
                                        
                                        <a href="#" onclick="remove_all()"class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span> Remove All</a>
                                        
                                        <!--<a href="<?php echo base_url()?>shop/reserve_order?id=<?php echo $user_session['id']?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-save"></span> Reserve Order</a>-->     
                ...
                function remove_all() {
                    bootbox.confirm("<font size='4'><b>Are you sure you want to remove all items in your cart?</b></font>", function(result) {
                        if (result)
                            window.location = "<?php echo base_url() ?>shop/destroy_Cart";
                    });
                }
                </script>
