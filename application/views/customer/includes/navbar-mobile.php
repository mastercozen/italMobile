            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a href="<?php echo base_url() ?>profile?id=<?php echo $user_session['id'];?>" class="navbar-brand"  style="font-size:14px;">
                        Logged as: <?php echo $user_session['first_name'];?>
                    </a>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <!--<li><a href="<?php echo base_url()?>reservation?id=<?php echo $user_session['id'];?>"><span class="glyphicon glyphicon-save"></span> Reserve Orders</a></li>-->
