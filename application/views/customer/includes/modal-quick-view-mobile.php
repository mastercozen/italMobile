        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                    ...
                    function quick_view(id){
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                $("#ajax-prod-form").attr("action", "<?php echo base_url() . 'shop_mobile/add_to_cart/'?>"+product_id);
                ...
                $( "#quick-view-select" ).change(function () {
                    ...
                    $.ajax({
                        url : "<?php echo base_url()?>shop_mobile/test?id="+product_id+"&size="+size,  
                      type: "POST",
                        ...
                        success: function(data){
                            ...
                            console.log(data);
                            $("#stocks-available").text("Online: "+json['result'][0][size]);
