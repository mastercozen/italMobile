...
class Paypal {
	...
	function __initialize($props = array())
	{
		...
		#Page Layout -->
		$config["cpp_header_image"] 		= ''; //Image header url [750 pixels wide by 90 pixels high]
		$config["cpp_cart_border_color"] 	= '009933'; //The HTML hex code for your principal identifying color
	 ...
	 * @return	void
	 */	
	function add($item_name = '', $item_amount = NULL, $item_qty = NULL, $item_size = ''){
		...
		$this->config['on0_'.$this->item] 	= 'Size';
		$this->config['os0_'.$this->item] 	= $item_size;
		

                
		$this->item++;
	}
	function add2($item_name = '', $item_amount = NULL){
		$this->config['item_name_'.$this->item] 	= $item_name;
		$this->config['amount_'.$this->item] 		= $item_amount;
